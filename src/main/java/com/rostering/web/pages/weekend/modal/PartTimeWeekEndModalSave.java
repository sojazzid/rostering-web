...
public class PartTimeWeekEndModalSave extends Modal {
    ...
    public PartTimeWeekEndModalSave(String markupId, String title) {
        super(markupId);
    ...
    public PartTimeWeekEndModalButton getButton(String label) {
        return new PartTimeWeekEndModalButton("button", label) {

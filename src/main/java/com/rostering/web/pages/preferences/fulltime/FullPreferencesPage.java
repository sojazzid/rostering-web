...
public class FullPreferencesPage extends BasePage {
    ...
    private FullEditModal editModal;
    ...
    public FullPreferencesPage() {

        formFilter = createForm("formFilter", new FullPreferencesFormFilter());
        add(formFilter);
        ...
        editForm = createForm("editModalForm", new FullEditModalFilter());
        editForm.setOutputMarkupId(true);
        add(editForm);

        editModal = new FullEditModal("editModal", "Editar preferencia", this);
    ...
    private List<Preference> getPreferences(Driver driver, Shift shift) {
        ...
        try {
            ...
            if (null != driver && null == shift) {
               ...
               // preferences.addAll(preferenceDao.getPreferences(ShiftType.FULL_TIME));
            }
        } catch (Exception e) {
            error(e.getMessage());
        }
    ...
    protected String getPageTitle() {
        return "Ingresar Preferencias Full-time";
    }

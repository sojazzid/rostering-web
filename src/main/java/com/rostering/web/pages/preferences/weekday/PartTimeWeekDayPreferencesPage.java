...
import com.rostering.web.pages.preferences.weekday.modal.PartTimeWeekDayEditModalFilter;
import com.rostering.web.pages.preferences.weekday.modal.PartTimeWeekDayEditModal;
...
public class PartTimeWeekDayPreferencesPage extends BasePage {
    ...
    private PartTimeWeekDayEditModal editModal;
    ...
    public PartTimeWeekDayPreferencesPage() {

        formFilter = createForm("formFilter", new PartTimeWeekDayPreferencesFormFilter());
        add(formFilter);
        ...
        editForm = createForm("editModalForm", new PartTimeWeekDayEditModalFilter());
        editForm.setOutputMarkupId(true);
        add(editForm);

        editModal = new PartTimeWeekDayEditModal("editModal", "Editar preferencia", this);
    ...
    private List<Preference> getPreferences(Driver driver, Shift shift) {
        ...
        try {
            ...
            if (null != driver && null == shift) {
                ...
                //preferences.addAll(preferenceDao.getPreferences(ShiftType.PART_TIME_WEEKDAY));
            }
        } catch (Exception e) {
            error(e.getMessage());
        }
    ...
    protected String getPageTitle() {
        return "Ingresar Preferencias Part-time Semana";
    }

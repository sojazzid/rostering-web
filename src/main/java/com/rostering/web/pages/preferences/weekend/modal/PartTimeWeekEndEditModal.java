...
public class PartTimeWeekEndEditModal extends Modal {
    ...
    private final PartTimeWeekEndPreferencesPage partTimeWeekEndPreferencesPage;


    public PartTimeWeekEndEditModal(String markupId, String title, PartTimeWeekEndPreferencesPage partTimeWeekEndPreferencesPage) {
        super(markupId);

        this.partTimeWeekEndPreferencesPage = partTimeWeekEndPreferencesPage;
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                ...
                if (null != selectedPreference) {
                    ...
                    try {
                        ...
                        target.add(partTimeWeekEndPreferencesPage);

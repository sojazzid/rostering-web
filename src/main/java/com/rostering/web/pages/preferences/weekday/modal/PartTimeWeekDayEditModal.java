package com.rostering.web.pages.preferences.weekday.modal;
...
public class PartTimeWeekDayEditModal extends Modal {
    ...
    private final PartTimeWeekDayPreferencesPage partTimeWeekDayPreferencesPage;


    public PartTimeWeekDayEditModal(String markupId, String title, PartTimeWeekDayPreferencesPage partTimeWeekDayPreferencesPage) {
        super(markupId);

        this.partTimeWeekDayPreferencesPage = partTimeWeekDayPreferencesPage;
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                ...
                if (null != selectedPreference) {
                    ...
                    try {
                        ...
                        target.add(partTimeWeekDayPreferencesPage);
